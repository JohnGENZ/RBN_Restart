...
Place the script in C:\Scripts and the batch file in your startup folder.  Please do not start the Agregator and Skimmer directly; let the script handle it.  Create C:\Logs for the log.
